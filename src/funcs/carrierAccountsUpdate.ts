 ...
 */
export async function carrierAccountsUpdate(
    client$: ShippoCore,
...
> {
    ...
    const path$ = pathToFunc("/carrier_accounts/{CarrierAccountId}")(pathParams$);
    ...
    const [result$] = await m$.match<
        ...
        | ConnectionError
    >(
        m$.json(200, components.CarrierAccount$inboundSchema),
        m$.fail([400, "4XX", "5XX"])
    )(response);
    if (!result$.ok) {
        return result$;
