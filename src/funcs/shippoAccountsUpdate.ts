 ...
 */
export function shippoAccountsUpdate(
  client: ShippoCore,
...
> {
  ...
  const parsed = safeParse(
    input,
    (value) =>
      z.parse(operations.UpdateShippoAccountRequest$outboundSchema, value),
  ...
  const body = encodeJSON("body", payload.ShippoAccountUpdateRequest, {
    explode: true,
  });
