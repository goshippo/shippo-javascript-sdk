...
/** @internal */
export const ListOrdersGlobals$inboundSchema: z.ZodType<ListOrdersGlobals, z.ZodTypeDef, unknown> =
    z
        .object({
...
/** @internal */
export const ListOrdersRequest$inboundSchema: z.ZodType<ListOrdersRequest, z.ZodTypeDef, unknown> =
    z
        .object({
