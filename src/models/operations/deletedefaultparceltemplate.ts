...
export namespace DeleteDefaultParcelTemplateGlobals$ {
    ...
    export const outboundSchema = DeleteDefaultParcelTemplateGlobals$outboundSchema;
...
export namespace DeleteDefaultParcelTemplateRequest$ {
    ...
    export const outboundSchema = DeleteDefaultParcelTemplateRequest$outboundSchema;
