...
/** @internal */
export const GetBatchGlobals$inboundSchema: z.ZodType<GetBatchGlobals, z.ZodTypeDef, unknown> = z
    .object({
...
/** @internal */
export const GetBatchRequest$inboundSchema: z.ZodType<GetBatchRequest, z.ZodTypeDef, unknown> = z
    .object({
        BatchId: z.string(),
    })
    .transform((v) => {
