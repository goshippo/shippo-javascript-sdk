...
/** @internal */
export const GetParcelGlobals$inboundSchema: z.ZodType<GetParcelGlobals, z.ZodTypeDef, unknown> = z
    .object({
...
/** @internal */
export const GetParcelRequest$inboundSchema: z.ZodType<GetParcelRequest, z.ZodTypeDef, unknown> = z
    .object({
        ParcelId: z.string(),
    })
    .transform((v) => {
