...
/** @internal */
export const GetRateGlobals$inboundSchema: z.ZodType<GetRateGlobals, z.ZodTypeDef, unknown> = z
    .object({
...
/** @internal */
export const GetRateRequest$inboundSchema: z.ZodType<GetRateRequest, z.ZodTypeDef, unknown> = z
    .object({
        RateId: z.string(),
    })
    .transform((v) => {
