...
export namespace ListCustomsDeclarationsGlobals$ {
    export const inboundSchema: z.ZodType<ListCustomsDeclarationsGlobals, z.ZodTypeDef, unknown> = z
        .object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, ListCustomsDeclarationsGlobals> =
        z
            .object({
...
export namespace ListCustomsDeclarationsRequest$ {
    export const inboundSchema: z.ZodType<ListCustomsDeclarationsRequest, z.ZodTypeDef, unknown> =
        z.object({
