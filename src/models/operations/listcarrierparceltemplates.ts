...
export namespace ListCarrierParcelTemplatesGlobals$ {
    ...
    export const outboundSchema = ListCarrierParcelTemplatesGlobals$outboundSchema;
...
/** @internal */
export const Include$inboundSchema: z.ZodNativeEnum<typeof Include> = z.nativeEnum(Include);

/** @internal */
export const Include$outboundSchema: z.ZodNativeEnum<typeof Include> = Include$inboundSchema;
...
export namespace ListCarrierParcelTemplatesRequest$ {
    ...
    export const outboundSchema = ListCarrierParcelTemplatesRequest$outboundSchema;
