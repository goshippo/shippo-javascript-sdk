...
export type BatchShipment = {
     ...
     */
    messages?: Array<ErrorMessage> | undefined;
    /**
...
export namespace BatchShipment$ {
    export type Inbound = {
        ...
        messages?: Array<ErrorMessage$.Inbound> | undefined;
        object_id: string;
        status: Status;
        transaction?: string | undefined;
    };
    ...
    export const inboundSchema: z.ZodType<BatchShipment, z.ZodTypeDef, Inbound> = z
        .object({
            ...
            messages: z.array(ErrorMessage$.inboundSchema).optional(),
            object_id: z.string(),
            status: Status$,
    ...
    export type Outbound = {
        ...
        messages?: Array<ErrorMessage$.Outbound> | undefined;
        object_id: string;
        status: Status;
        transaction?: string | undefined;
    };
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, BatchShipment> = z
        .object({
            ...
            messages: z.array(ErrorMessage$.outboundSchema).optional(),
            objectId: z.string(),
            status: Status$,
            transaction: z.string().optional(),
        })
