...
> = z
    .object({
        address_from: z.union([AddressCompleteCreateRequest$inboundSchema, z.string()]).optional(),
...
> = z
    .object({
        addressFrom: z.union([AddressCompleteCreateRequest$outboundSchema, z.string()]).optional(),
