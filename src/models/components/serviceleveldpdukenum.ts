...
/** @internal */
export const ServiceLevelDPDUKEnum$inboundSchema: z.ZodMiniEnum<
  typeof ServiceLevelDPDUKEnum
> = z.enum(ServiceLevelDPDUKEnum);
/** @internal */
export const ServiceLevelDPDUKEnum$outboundSchema: z.ZodMiniEnum<
  typeof ServiceLevelDPDUKEnum
