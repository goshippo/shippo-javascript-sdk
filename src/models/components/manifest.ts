...
/** @internal */
export const ManifestStatus$inboundSchema: z.ZodNativeEnum<typeof ManifestStatus> =
    z.nativeEnum(ManifestStatus);

/** @internal */
export const ManifestStatus$outboundSchema: z.ZodNativeEnum<typeof ManifestStatus> =
...
/** @internal */
export const Manifest$inboundSchema: z.ZodType<Manifest, z.ZodTypeDef, unknown> = z
    .object({
...
/** @internal */
export const Manifest$outboundSchema: z.ZodType<Manifest$Outbound, z.ZodTypeDef, Manifest> = z
    .object({
