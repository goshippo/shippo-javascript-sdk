...
/** @internal */
export const CustomsDeclarationB13AFilingOptionEnum$inboundSchema: z.ZodNativeEnum<
    typeof CustomsDeclarationB13AFilingOptionEnum
> = z.nativeEnum(CustomsDeclarationB13AFilingOptionEnum);

/** @internal */
export const CustomsDeclarationB13AFilingOptionEnum$outboundSchema: z.ZodNativeEnum<
    typeof CustomsDeclarationB13AFilingOptionEnum
...
export namespace CustomsDeclarationB13AFilingOptionEnum$ {
    ...
    export const inboundSchema = CustomsDeclarationB13AFilingOptionEnum$inboundSchema;
    /** @deprecated use `CustomsDeclarationB13AFilingOptionEnum$outboundSchema` instead. */
    export const outboundSchema = CustomsDeclarationB13AFilingOptionEnum$outboundSchema;
}
