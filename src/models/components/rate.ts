...
import { RateMessage, RateMessage$ } from "./ratemessage";
...
export type Rate = {
     ...
     */
    messages?: Array<RateMessage> | undefined;
    /**
...
export namespace Rate$ {
    export type Inbound = {
        ...
        messages?: Array<RateMessage$.Inbound> | undefined;
    ...
    export const inboundSchema: z.ZodType<Rate, z.ZodTypeDef, Inbound> = z
        .object({
            ...
            messages: z.array(RateMessage$.inboundSchema).optional(),
            object_created: z
                .string()
    ...
    export type Outbound = {
        ...
        estimated_days?: number | undefined;
        included_insurance_price?: number | undefined;
        messages?: Array<RateMessage$.Outbound> | undefined;
        object_created: string;
        object_id: string;
        object_owner: string;
        provider: string;
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, Rate> = z
        .object({
            ...
            messages: z.array(RateMessage$.outboundSchema).optional(),
