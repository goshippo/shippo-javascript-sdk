...
/** @internal */
export const Attributes$inboundSchema: z.ZodNativeEnum<typeof Attributes> =
    z.nativeEnum(Attributes);
...
/** @internal */
export const Rate$outboundSchema: z.ZodType<Rate$Outbound, z.ZodTypeDef, Rate> = z
    .object({
        amount: z.string(),
