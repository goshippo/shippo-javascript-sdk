...
/** @internal */
export const UserParcelTemplateWithoutCarrierTemplateCreateRequest$inboundSchema: z.ZodType<
...
/** @internal */
export const UserParcelTemplateWithoutCarrierTemplateCreateRequest$outboundSchema: z.ZodType<
...
export namespace UserParcelTemplateWithoutCarrierTemplateCreateRequest$ {
    ...
    export type Outbound = UserParcelTemplateWithoutCarrierTemplateCreateRequest$Outbound;
}
