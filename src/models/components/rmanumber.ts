...
/** @internal */
export const RmaNumber$inboundSchema: z.ZodType<RmaNumber, z.ZodTypeDef, unknown> = z
    .object({
...
/** @internal */
export const RmaNumber$outboundSchema: z.ZodType<RmaNumber$Outbound, z.ZodTypeDef, RmaNumber> = z
    .object({
        prefix: z.string().optional(),
        value: z.string().optional(),
