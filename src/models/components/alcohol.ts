...
/** @internal */
export const RecipientType$inboundSchema: z.ZodNativeEnum<typeof RecipientType> =
    z.nativeEnum(RecipientType);

/** @internal */
export const RecipientType$outboundSchema: z.ZodNativeEnum<typeof RecipientType> =
...
/** @internal */
export const Alcohol$inboundSchema: z.ZodType<Alcohol, z.ZodTypeDef, unknown> = z
    .object({
...
/** @internal */
export const Alcohol$outboundSchema: z.ZodType<Alcohol$Outbound, z.ZodTypeDef, Alcohol> = z
    .object({
