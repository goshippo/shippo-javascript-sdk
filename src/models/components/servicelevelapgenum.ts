...
/** @internal */
export const ServiceLevelAPGEnum$inboundSchema: z.ZodNativeEnum<typeof ServiceLevelAPGEnum> =
    z.nativeEnum(ServiceLevelAPGEnum);

/** @internal */
export const ServiceLevelAPGEnum$outboundSchema: z.ZodNativeEnum<typeof ServiceLevelAPGEnum> =
