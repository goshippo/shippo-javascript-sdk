...
/** @internal */
export const CarrierAccountChronopostCreateRequestParameters$inboundSchema: z.ZodType<
...
/** @internal */
export const CarrierAccountChronopostCreateRequestParameters$outboundSchema: z.ZodType<
...
export namespace CarrierAccountChronopostCreateRequestParameters$ {
    ...
    export const inboundSchema = CarrierAccountChronopostCreateRequestParameters$inboundSchema;
    /** @deprecated use `CarrierAccountChronopostCreateRequestParameters$outboundSchema` instead. */
    export const outboundSchema = CarrierAccountChronopostCreateRequestParameters$outboundSchema;
    /** @deprecated use `CarrierAccountChronopostCreateRequestParameters$Outbound` instead. */
    export type Outbound = CarrierAccountChronopostCreateRequestParameters$Outbound;
}
...
export namespace CarrierAccountChronopostCreateRequest$ {
    ...
    export const inboundSchema = CarrierAccountChronopostCreateRequest$inboundSchema;
    /** @deprecated use `CarrierAccountChronopostCreateRequest$outboundSchema` instead. */
    export const outboundSchema = CarrierAccountChronopostCreateRequest$outboundSchema;
