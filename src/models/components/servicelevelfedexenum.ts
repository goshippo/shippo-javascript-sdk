...
/** @internal */
export const ServiceLevelFedExEnum$inboundSchema: z.ZodMiniEnum<
  typeof ServiceLevelFedExEnum
> = z.enum(ServiceLevelFedExEnum);
/** @internal */
export const ServiceLevelFedExEnum$outboundSchema: z.ZodMiniEnum<
  typeof ServiceLevelFedExEnum
