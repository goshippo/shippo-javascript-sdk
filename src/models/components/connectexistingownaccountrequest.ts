...
/** @internal */
export const ConnectExistingOwnAccountRequestParameters$inboundSchema: z.ZodType<
...
/** @internal */
export const ConnectExistingOwnAccountRequestParameters$outboundSchema: z.ZodType<
...
export namespace ConnectExistingOwnAccountRequestParameters$ {
    ...
    export const inboundSchema = ConnectExistingOwnAccountRequestParameters$inboundSchema;
    /** @deprecated use `ConnectExistingOwnAccountRequestParameters$outboundSchema` instead. */
    export const outboundSchema = ConnectExistingOwnAccountRequestParameters$outboundSchema;
