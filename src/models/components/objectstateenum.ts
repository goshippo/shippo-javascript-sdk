...
/** @internal */
export const ObjectStateEnum$inboundSchema: z.ZodNativeEnum<typeof ObjectStateEnum> =
    z.nativeEnum(ObjectStateEnum);

/** @internal */
export const ObjectStateEnum$outboundSchema: z.ZodNativeEnum<typeof ObjectStateEnum> =
