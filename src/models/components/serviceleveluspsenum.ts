...
/** @internal */
export const ServiceLevelUSPSEnum$inboundSchema: z.ZodNativeEnum<typeof ServiceLevelUSPSEnum> =
    z.nativeEnum(ServiceLevelUSPSEnum);

/** @internal */
export const ServiceLevelUSPSEnum$outboundSchema: z.ZodNativeEnum<typeof ServiceLevelUSPSEnum> =
