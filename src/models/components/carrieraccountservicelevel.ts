    ...
    export const inboundSchema: z.ZodType<CarrierAccountServiceLevel, z.ZodTypeDef, Inbound> = z
        ...
        .transform((v) => {
            return {
                ...
                ...(v.supports_return_labels === undefined
                    ? null
                    : { supportsReturnLabels: v.supports_return_labels }),
            };
        });
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, CarrierAccountServiceLevel> = z
        ...
        .transform((v) => {
            return {
                ...(v.name === undefined ? null : { name: v.name }),
                ...(v.token === undefined ? null : { token: v.token }),
                ...(v.supportsReturnLabels === undefined
                    ? null
                    : { supports_return_labels: v.supportsReturnLabels }),
            };
        });
}
