...
export namespace AddressValidationResultsMessageCodeEnum$ {
    export const inboundSchema: z.ZodNativeEnum<typeof AddressValidationResultsMessageCodeEnum> =
        z.nativeEnum(AddressValidationResultsMessageCodeEnum);
    export const outboundSchema: z.ZodNativeEnum<typeof AddressValidationResultsMessageCodeEnum> =
        inboundSchema;
}
