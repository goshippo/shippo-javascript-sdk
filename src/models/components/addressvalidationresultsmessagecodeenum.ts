...
/** @internal */
export const AddressValidationResultsMessageCodeEnum$inboundSchema: z.ZodNativeEnum<
    typeof AddressValidationResultsMessageCodeEnum
> = z.nativeEnum(AddressValidationResultsMessageCodeEnum);

/** @internal */
export const AddressValidationResultsMessageCodeEnum$outboundSchema: z.ZodNativeEnum<
    typeof AddressValidationResultsMessageCodeEnum
...
export namespace AddressValidationResultsMessageCodeEnum$ {
    ...
    export const inboundSchema = AddressValidationResultsMessageCodeEnum$inboundSchema;
    /** @deprecated use `AddressValidationResultsMessageCodeEnum$outboundSchema` instead. */
    export const outboundSchema = AddressValidationResultsMessageCodeEnum$outboundSchema;
}
