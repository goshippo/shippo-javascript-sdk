...
/** @internal */
export const CoreRate$inboundSchema: z.ZodType<CoreRate, z.ZodTypeDef, unknown> = z
    .object({
...
/** @internal */
export const CoreRate$outboundSchema: z.ZodType<CoreRate$Outbound, z.ZodTypeDef, CoreRate> = z
    .object({
        amount: z.string().optional(),
