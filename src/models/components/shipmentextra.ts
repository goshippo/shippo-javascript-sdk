...
import { Cod, Cod$inboundSchema, Cod$Outbound, Cod$outboundSchema } from "./cod.js";
import {
    CustomerReference,
...
import { DryIce, DryIce$inboundSchema, DryIce$Outbound, DryIce$outboundSchema } from "./dryice.js";
import {
    Insurance,
...
/** @internal */
export const AncillaryEndorsement$inboundSchema: z.ZodNativeEnum<typeof AncillaryEndorsement> =
    z.nativeEnum(AncillaryEndorsement);

/** @internal */
export const AncillaryEndorsement$outboundSchema: z.ZodNativeEnum<typeof AncillaryEndorsement> =
...
/** @internal */
export const DangerousGoodsCode$inboundSchema: z.ZodNativeEnum<typeof DangerousGoodsCode> =
    z.nativeEnum(DangerousGoodsCode);

/** @internal */
export const DangerousGoodsCode$outboundSchema: z.ZodNativeEnum<typeof DangerousGoodsCode> =
...
/** @internal */
export const ReturnServiceType$inboundSchema: z.ZodType<ReturnServiceType, z.ZodTypeDef, unknown> =
    z.union([
        ShipmentExtraReturnServiceTypeUPSEnum$inboundSchema,
        ShipmentExtraReturnServiceTypeLasershipEnum$inboundSchema,
    ]);
...
/** @internal */
export const SignatureConfirmation$inboundSchema: z.ZodNativeEnum<typeof SignatureConfirmation> =
    z.nativeEnum(SignatureConfirmation);

/** @internal */
export const SignatureConfirmation$outboundSchema: z.ZodNativeEnum<typeof SignatureConfirmation> =
...
/** @internal */
export const ShipmentExtra$inboundSchema: z.ZodType<ShipmentExtra, z.ZodTypeDef, unknown> = z
    .object({
        ...
        lasership_attrs: z.array(ShipmentExtraLasershipAttributesEnum$inboundSchema).optional(),
...
> = z
    .object({
        ...
        lasershipAttrs: z.array(ShipmentExtraLasershipAttributesEnum$outboundSchema).optional(),
