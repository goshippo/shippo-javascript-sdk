...
export namespace FedExConnectExistingOwnAccountParameters$ {
    ...
    export const inboundSchema = FedExConnectExistingOwnAccountParameters$inboundSchema;
    /** @deprecated use `FedExConnectExistingOwnAccountParameters$outboundSchema` instead. */
    export const outboundSchema = FedExConnectExistingOwnAccountParameters$outboundSchema;
