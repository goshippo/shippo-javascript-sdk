...
/** @internal */
export const AddressFrom$inboundSchema: z.ZodType<AddressFrom, z.ZodTypeDef, unknown> = z.union([
    AddressCreateRequest$inboundSchema,
    z.string(),
]);
...
/** @internal */
export const AddressReturn$inboundSchema: z.ZodType<AddressReturn, z.ZodTypeDef, unknown> = z.union(
    [AddressCreateRequest$inboundSchema, z.string()]
);
...
/** @internal */
export const AddressTo$inboundSchema: z.ZodType<AddressTo, z.ZodTypeDef, unknown> = z.union([
    AddressCreateRequest$inboundSchema,
    z.string(),
]);
...
/** @internal */
export const AddressTo$outboundSchema: z.ZodType<AddressTo$Outbound, z.ZodTypeDef, AddressTo> =
    z.union([AddressCreateRequest$outboundSchema, z.string()]);
...
export namespace ShipmentCreateRequestCustomsDeclaration$ {
    ...
    export const inboundSchema = ShipmentCreateRequestCustomsDeclaration$inboundSchema;
    /** @deprecated use `ShipmentCreateRequestCustomsDeclaration$outboundSchema` instead. */
    export const outboundSchema = ShipmentCreateRequestCustomsDeclaration$outboundSchema;
...
/** @internal */
export const Parcels$inboundSchema: z.ZodType<Parcels, z.ZodTypeDef, unknown> = z.union([
    ParcelCreateFromTemplateRequest$inboundSchema,
    ParcelCreateRequest$inboundSchema,
    z.string(),
]);
...
/** @internal */
export const Parcels$outboundSchema: z.ZodType<Parcels$Outbound, z.ZodTypeDef, Parcels> = z.union([
    ParcelCreateFromTemplateRequest$outboundSchema,
    ParcelCreateRequest$outboundSchema,
    z.string(),
]);
