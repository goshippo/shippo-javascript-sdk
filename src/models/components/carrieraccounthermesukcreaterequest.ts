...
/** @internal */
export const CarrierAccountHermesUKCreateRequestParameters$inboundSchema: z.ZodType<
...
/** @internal */
export const CarrierAccountHermesUKCreateRequestParameters$outboundSchema: z.ZodType<
...
export namespace CarrierAccountHermesUKCreateRequestParameters$ {
    ...
    export const inboundSchema = CarrierAccountHermesUKCreateRequestParameters$inboundSchema;
    /** @deprecated use `CarrierAccountHermesUKCreateRequestParameters$outboundSchema` instead. */
    export const outboundSchema = CarrierAccountHermesUKCreateRequestParameters$outboundSchema;
...
export namespace CarrierAccountHermesUKCreateRequest$ {
    ...
    export const inboundSchema = CarrierAccountHermesUKCreateRequest$inboundSchema;
    /** @deprecated use `CarrierAccountHermesUKCreateRequest$outboundSchema` instead. */
    export const outboundSchema = CarrierAccountHermesUKCreateRequest$outboundSchema;
