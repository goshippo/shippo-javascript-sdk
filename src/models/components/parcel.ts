...
export type Parcel = {
     ...
     * A Parcel will only be valid when all required values have been sent and validated successfully.
     */
    objectState?: ParcelObjectState | undefined;
    /**
...
/** @internal */
export const ParcelObjectState$ = z.nativeEnum(ParcelObjectState);
...
export namespace Parcel$ {
    export type Inbound = {
        ...
        object_state?: ParcelObjectState | undefined;
    ...
    export const inboundSchema: z.ZodType<Parcel, z.ZodTypeDef, Inbound> = z
        .object({
            ...
            object_state: ParcelObjectState$.optional(),
            object_updated: z
                .string()
                .datetime({ offset: true })
                .transform((v) => new Date(v))
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, Parcel> = z
        .object({
            ...
            objectState: ParcelObjectState$.optional(),
            objectUpdated: z
                .date()
                .transform((v) => v.toISOString())
                .optional(),
