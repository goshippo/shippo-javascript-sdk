...
/** @internal */
export const ObjectState$inboundSchema: z.ZodNativeEnum<typeof ObjectState> =
    z.nativeEnum(ObjectState);
...
/** @internal */
export const Parcel$outboundSchema: z.ZodType<Parcel$Outbound, z.ZodTypeDef, Parcel> = z
    .object({
