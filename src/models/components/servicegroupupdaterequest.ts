...
/** @internal */
export const ServiceGroupUpdateRequest$inboundSchema: z.ZodType<
...
/** @internal */
export const ServiceGroupUpdateRequest$outboundSchema: z.ZodType<
 ...
 */
export namespace ServiceGroupUpdateRequest$ {
  /** @deprecated use `ServiceGroupUpdateRequest$inboundSchema` instead. */
  export const inboundSchema = ServiceGroupUpdateRequest$inboundSchema;
