...
/** @internal */
export const WebhookEventTypeEnum$inboundSchema: z.ZodNativeEnum<typeof WebhookEventTypeEnum> =
    z.nativeEnum(WebhookEventTypeEnum);

/** @internal */
export const WebhookEventTypeEnum$outboundSchema: z.ZodNativeEnum<typeof WebhookEventTypeEnum> =
