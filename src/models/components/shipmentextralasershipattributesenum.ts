...
/** @internal */
export const ShipmentExtraLasershipAttributesEnum$inboundSchema: z.ZodNativeEnum<
    typeof ShipmentExtraLasershipAttributesEnum
> = z.nativeEnum(ShipmentExtraLasershipAttributesEnum);

/** @internal */
export const ShipmentExtraLasershipAttributesEnum$outboundSchema: z.ZodNativeEnum<
    typeof ShipmentExtraLasershipAttributesEnum
...
export namespace ShipmentExtraLasershipAttributesEnum$ {
    ...
    export const inboundSchema = ShipmentExtraLasershipAttributesEnum$inboundSchema;
    /** @deprecated use `ShipmentExtraLasershipAttributesEnum$outboundSchema` instead. */
    export const outboundSchema = ShipmentExtraLasershipAttributesEnum$outboundSchema;
}
