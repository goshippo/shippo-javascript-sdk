...
/** @internal */
export const TrackingStatusEnum$inboundSchema: z.ZodNativeEnum<typeof TrackingStatusEnum> =
    z.nativeEnum(TrackingStatusEnum);

/** @internal */
export const TrackingStatusEnum$outboundSchema: z.ZodNativeEnum<typeof TrackingStatusEnum> =
