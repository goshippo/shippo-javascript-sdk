...
import { CustomsTaxIdentification, CustomsTaxIdentification$ } from "./customstaxidentification";
...
export namespace CustomsExporterIdentification$ {
    export const inboundSchema: z.ZodType<CustomsExporterIdentification, z.ZodTypeDef, unknown> = z
        ...
        .transform((v) => {
            return {
                ...(v.eori_number === undefined ? null : { eoriNumber: v.eori_number }),
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, CustomsExporterIdentification> =
        z
            ...
            .transform((v) => {
                return {
                    ...(v.eoriNumber === undefined ? null : { eori_number: v.eoriNumber }),
