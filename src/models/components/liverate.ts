...
/** @internal */
export const LiveRate$inboundSchema: z.ZodType<LiveRate, z.ZodTypeDef, unknown> = z
    .object({
...
/** @internal */
export const LiveRate$outboundSchema: z.ZodType<LiveRate$Outbound, z.ZodTypeDef, LiveRate> = z
    .object({
        amount: z.string().optional(),
