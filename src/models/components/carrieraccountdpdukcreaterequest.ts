...
/** @internal */
export const CarrierAccountDPDUKCreateRequestParameters$inboundSchema: z.ZodType<
...
/** @internal */
export const CarrierAccountDPDUKCreateRequestParameters$outboundSchema: z.ZodType<
...
export namespace CarrierAccountDPDUKCreateRequestParameters$ {
    ...
    export const inboundSchema = CarrierAccountDPDUKCreateRequestParameters$inboundSchema;
    /** @deprecated use `CarrierAccountDPDUKCreateRequestParameters$outboundSchema` instead. */
    export const outboundSchema = CarrierAccountDPDUKCreateRequestParameters$outboundSchema;
