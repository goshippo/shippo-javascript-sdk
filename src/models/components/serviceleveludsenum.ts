...
/** @internal */
export const ServiceLevelUDSEnum$inboundSchema: z.ZodNativeEnum<typeof ServiceLevelUDSEnum> =
    z.nativeEnum(ServiceLevelUDSEnum);

/** @internal */
export const ServiceLevelUDSEnum$outboundSchema: z.ZodNativeEnum<typeof ServiceLevelUDSEnum> =
