...
/** @internal */
export const ServiceLevelAPCPostalEnum$inboundSchema: z.ZodMiniEnum<
  typeof ServiceLevelAPCPostalEnum
> = z.enum(ServiceLevelAPCPostalEnum);
/** @internal */
export const ServiceLevelAPCPostalEnum$outboundSchema: z.ZodMiniEnum<
  typeof ServiceLevelAPCPostalEnum
