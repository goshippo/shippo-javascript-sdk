...
export namespace CarrierAccountUPSCreateRequestParameters$ {
    ...
    export const inboundSchema = CarrierAccountUPSCreateRequestParameters$inboundSchema;
    /** @deprecated use `CarrierAccountUPSCreateRequestParameters$outboundSchema` instead. */
    export const outboundSchema = CarrierAccountUPSCreateRequestParameters$outboundSchema;
