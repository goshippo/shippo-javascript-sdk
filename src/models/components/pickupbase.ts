...
/** @internal */
export const PickupBase$inboundSchema: z.ZodType<PickupBase, z.ZodTypeDef, unknown> = z
    .object({
...
/** @internal */
export const PickupBase$outboundSchema: z.ZodType<PickupBase$Outbound, z.ZodTypeDef, PickupBase> = z
    .object({
