...
/** @internal */
export const BuildingLocationType$inboundSchema: z.ZodNativeEnum<typeof BuildingLocationType> =
    z.nativeEnum(BuildingLocationType);

/** @internal */
export const BuildingLocationType$outboundSchema: z.ZodNativeEnum<typeof BuildingLocationType> =
...
/** @internal */
export const Location$inboundSchema: z.ZodType<Location, z.ZodTypeDef, unknown> = z
    .object({
