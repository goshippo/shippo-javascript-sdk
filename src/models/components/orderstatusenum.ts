...
/** @internal */
export const OrderStatusEnum$inboundSchema: z.ZodNativeEnum<typeof OrderStatusEnum> =
    z.nativeEnum(OrderStatusEnum);

/** @internal */
export const OrderStatusEnum$outboundSchema: z.ZodNativeEnum<typeof OrderStatusEnum> =
