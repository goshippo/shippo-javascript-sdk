...
/** @internal */
export const Latitude$inboundSchema: z.ZodType<Latitude, z.ZodTypeDef, unknown> = z.union([
    z.number(),
    z.string(),
]);
...
/** @internal */
export const Latitude$outboundSchema: z.ZodType<Latitude$Outbound, z.ZodTypeDef, Latitude> =
...
/** @internal */
export const Longitude$inboundSchema: z.ZodType<Longitude, z.ZodTypeDef, unknown> = z.union([
    z.number(),
    z.string(),
]);
...
/** @internal */
export const Longitude$outboundSchema: z.ZodType<Longitude$Outbound, z.ZodTypeDef, Longitude> =
    z.union([z.number(), z.string()]);
