...
export namespace CarrierAccountCanadaPostCreateParameters$ {
    ...
    export const inboundSchema = CarrierAccountCanadaPostCreateParameters$inboundSchema;
    /** @deprecated use `CarrierAccountCanadaPostCreateParameters$outboundSchema` instead. */
    export const outboundSchema = CarrierAccountCanadaPostCreateParameters$outboundSchema;
