...
/** @internal */
export const ServiceLevelDHLExpressEnum$inboundSchema: z.ZodMiniEnum<
  typeof ServiceLevelDHLExpressEnum
> = z.enum(ServiceLevelDHLExpressEnum);
/** @internal */
export const ServiceLevelDHLExpressEnum$outboundSchema: z.ZodMiniEnum<
  typeof ServiceLevelDHLExpressEnum
