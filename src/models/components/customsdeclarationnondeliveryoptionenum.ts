...
/** @internal */
export const CustomsDeclarationNonDeliveryOptionEnum$inboundSchema: z.ZodNativeEnum<
    typeof CustomsDeclarationNonDeliveryOptionEnum
> = z.nativeEnum(CustomsDeclarationNonDeliveryOptionEnum);

/** @internal */
export const CustomsDeclarationNonDeliveryOptionEnum$outboundSchema: z.ZodNativeEnum<
    typeof CustomsDeclarationNonDeliveryOptionEnum
...
export namespace CustomsDeclarationNonDeliveryOptionEnum$ {
    ...
    export const inboundSchema = CustomsDeclarationNonDeliveryOptionEnum$inboundSchema;
    /** @deprecated use `CustomsDeclarationNonDeliveryOptionEnum$outboundSchema` instead. */
    export const outboundSchema = CustomsDeclarationNonDeliveryOptionEnum$outboundSchema;
}
