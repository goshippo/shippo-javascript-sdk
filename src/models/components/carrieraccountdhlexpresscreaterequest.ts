...
export namespace CarrierAccountDHLExpressCreateRequest$ {
    ...
    export const inboundSchema = CarrierAccountDHLExpressCreateRequest$inboundSchema;
    /** @deprecated use `CarrierAccountDHLExpressCreateRequest$outboundSchema` instead. */
    export const outboundSchema = CarrierAccountDHLExpressCreateRequest$outboundSchema;
