...
/** @internal */
export const CarrierAccountMondialRelayCreateRequestParameters$inboundSchema: z.ZodType<
...
/** @internal */
export const CarrierAccountMondialRelayCreateRequestParameters$outboundSchema: z.ZodType<
...
export namespace CarrierAccountMondialRelayCreateRequestParameters$ {
    ...
    export const inboundSchema = CarrierAccountMondialRelayCreateRequestParameters$inboundSchema;
    /** @deprecated use `CarrierAccountMondialRelayCreateRequestParameters$outboundSchema` instead. */
    export const outboundSchema = CarrierAccountMondialRelayCreateRequestParameters$outboundSchema;
    /** @deprecated use `CarrierAccountMondialRelayCreateRequestParameters$Outbound` instead. */
    export type Outbound = CarrierAccountMondialRelayCreateRequestParameters$Outbound;
}
...
export namespace CarrierAccountMondialRelayCreateRequest$ {
    ...
    export const inboundSchema = CarrierAccountMondialRelayCreateRequest$inboundSchema;
    /** @deprecated use `CarrierAccountMondialRelayCreateRequest$outboundSchema` instead. */
    export const outboundSchema = CarrierAccountMondialRelayCreateRequest$outboundSchema;
