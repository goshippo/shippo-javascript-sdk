...
/** @internal */
export const PoNumber$inboundSchema: z.ZodType<PoNumber, z.ZodTypeDef, unknown> = z
    .object({
...
/** @internal */
export const PoNumber$outboundSchema: z.ZodType<PoNumber$Outbound, z.ZodTypeDef, PoNumber> = z
    .object({
        prefix: z.string().optional(),
        value: z.string().optional(),
