...
/** @internal */
export const LabelFileType$inboundSchema: z.ZodNativeEnum<typeof LabelFileType> =
    z.nativeEnum(LabelFileType);

/** @internal */
export const LabelFileType$outboundSchema: z.ZodNativeEnum<typeof LabelFileType> =
