...
/** @internal */
export const ServiceLevelEvriUKEnum$inboundSchema: z.ZodNativeEnum<typeof ServiceLevelEvriUKEnum> =
    z.nativeEnum(ServiceLevelEvriUKEnum);

/** @internal */
export const ServiceLevelEvriUKEnum$outboundSchema: z.ZodNativeEnum<typeof ServiceLevelEvriUKEnum> =
