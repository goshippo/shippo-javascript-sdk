...
/** @internal */
export const CarrierAccountFedExCreateRequestParameters$inboundSchema: z.ZodType<
...
/** @internal */
export const CarrierAccountFedExCreateRequestParameters$outboundSchema: z.ZodType<
...
export namespace CarrierAccountFedExCreateRequestParameters$ {
    ...
    export const inboundSchema = CarrierAccountFedExCreateRequestParameters$inboundSchema;
    /** @deprecated use `CarrierAccountFedExCreateRequestParameters$outboundSchema` instead. */
    export const outboundSchema = CarrierAccountFedExCreateRequestParameters$outboundSchema;
