...
/** @internal */
export const TransactionStatusEnum$inboundSchema: z.ZodNativeEnum<typeof TransactionStatusEnum> =
    z.nativeEnum(TransactionStatusEnum);

/** @internal */
export const TransactionStatusEnum$outboundSchema: z.ZodNativeEnum<typeof TransactionStatusEnum> =
