...
/** @internal */
export const ServiceLevelVehoEnum$inboundSchema: z.ZodNativeEnum<typeof ServiceLevelVehoEnum> =
    z.nativeEnum(ServiceLevelVehoEnum);

/** @internal */
export const ServiceLevelVehoEnum$outboundSchema: z.ZodNativeEnum<typeof ServiceLevelVehoEnum> =
