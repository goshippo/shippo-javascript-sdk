...
/** @internal */
export const ObjectResults$inboundSchema: z.ZodType<ObjectResults, z.ZodTypeDef, unknown> = z
    .object({
...
/** @internal */
export const BatchStatus$inboundSchema: z.ZodNativeEnum<typeof BatchStatus> =
    z.nativeEnum(BatchStatus);
...
/** @internal */
export const Batch$outboundSchema: z.ZodType<Batch$Outbound, z.ZodTypeDef, Batch> = z
    .object({
