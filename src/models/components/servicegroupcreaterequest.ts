...
/** @internal */
export const ServiceGroupCreateRequest$inboundSchema: z.ZodType<
...
/** @internal */
export const ServiceGroupCreateRequest$outboundSchema: z.ZodType<
...
export namespace ServiceGroupCreateRequest$ {
  ...
  export const inboundSchema = ServiceGroupCreateRequest$inboundSchema;
