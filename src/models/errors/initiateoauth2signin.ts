...
/** @internal */
export const InitiateOauth2SigninCarrierAccountsResponseResponseBody$inboundSchema: z.ZodType<
...
/** @internal */
export const InitiateOauth2SigninCarrierAccountsResponseResponseBody$outboundSchema: z.ZodType<
...
export namespace InitiateOauth2SigninCarrierAccountsResponseResponseBody$ {
    ...
    export type Outbound = InitiateOauth2SigninCarrierAccountsResponseResponseBody$Outbound;
}

/** @internal */
export const InitiateOauth2SigninCarrierAccountsResponseBody$inboundSchema: z.ZodType<
...
/** @internal */
export const InitiateOauth2SigninCarrierAccountsResponseBody$outboundSchema: z.ZodType<
...
export namespace InitiateOauth2SigninCarrierAccountsResponseBody$ {
    ...
    export const inboundSchema = InitiateOauth2SigninCarrierAccountsResponseBody$inboundSchema;
    /** @deprecated use `InitiateOauth2SigninCarrierAccountsResponseBody$outboundSchema` instead. */
    export const outboundSchema = InitiateOauth2SigninCarrierAccountsResponseBody$outboundSchema;
    /** @deprecated use `InitiateOauth2SigninCarrierAccountsResponseBody$Outbound` instead. */
    export type Outbound = InitiateOauth2SigninCarrierAccountsResponseBody$Outbound;
}
