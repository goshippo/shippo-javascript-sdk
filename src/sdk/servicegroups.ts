...
export class ServiceGroups extends ClientSDK {
    ...
    async list(options?: RequestOptions): Promise<Array<components.ServiceGroup>> {
        return unwrapAsync(serviceGroupsList(this, options));
    }
    ...
    async create(
        ...
        return unwrapAsync(serviceGroupsCreate(this, request, options));
    }
    ...
    async update(
        ...
        return unwrapAsync(serviceGroupsUpdate(this, request, options));
    }
    ...
    async delete(serviceGroupId: string, options?: RequestOptions): Promise<void> {
        return unwrapAsync(serviceGroupsDelete(this, serviceGroupId, options));
    }
}
