...
export class Shipments extends ClientSDK {
    ...
    async list(
        ...
        return unwrapAsync(shipmentsList(this, request, options));
    }
    ...
    async create(
        ...
        return unwrapAsync(shipmentsCreate(this, request, options));
    }
    ...
    async get(shipmentId: string, options?: RequestOptions): Promise<components.Shipment> {
        return unwrapAsync(shipmentsGet(this, shipmentId, options));
    }
}
