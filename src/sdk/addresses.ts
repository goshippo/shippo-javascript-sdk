...
export class Addresses extends ClientSDK {
    ...
    async list(
        ...
        return unwrapAsync(addressesList(this, page, results, options));
    }
    ...
    async create(
        ...
        return unwrapAsync(addressesCreate(this, request, options));
    }
    ...
    async get(addressId: string, options?: RequestOptions): Promise<components.Address> {
        return unwrapAsync(addressesGet(this, addressId, options));
    }
    ...
    async validate(addressId: string, options?: RequestOptions): Promise<components.Address> {
        return unwrapAsync(addressesValidate(this, addressId, options));
    }
}
