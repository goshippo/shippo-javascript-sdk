...
export class Orders extends ClientSDK {
    ...
    async list(
        ...
        return unwrapAsync(ordersList(this, request, options));
    }
    ...
    async create(
        ...
        return unwrapAsync(ordersCreate(this, request, options));
    }
    ...
    async get(orderId: string, options?: RequestOptions): Promise<components.Order> {
        return unwrapAsync(ordersGet(this, orderId, options));
    }
}
