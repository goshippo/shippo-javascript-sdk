...
export class UserParcelTemplates extends ClientSDK {
    ...
    async list(options?: RequestOptions): Promise<components.UserParcelTemplateList> {
        return unwrapAsync(userParcelTemplatesList(this, options));
    }
    ...
    async create(
        ...
        return unwrapAsync(userParcelTemplatesCreate(this, request, options));
    }
    ...
    async delete(userParcelTemplateObjectId: string, options?: RequestOptions): Promise<void> {
        return unwrapAsync(userParcelTemplatesDelete(this, userParcelTemplateObjectId, options));
    }
    ...
    async get(
        ...
        return unwrapAsync(userParcelTemplatesGet(this, userParcelTemplateObjectId, options));
    }
