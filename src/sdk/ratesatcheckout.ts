...
export class RatesAtCheckout extends ClientSDK {
    ...
    async create(
        ...
        return unwrapAsync(ratesAtCheckoutCreate(this, request, options));
    }
    ...
    async getDefaultParcelTemplate(
        ...
        return unwrapAsync(ratesAtCheckoutGetDefaultParcelTemplate(this, options));
    }
    ...
    async updateDefaultParcelTemplate(
        ...
        return unwrapAsync(ratesAtCheckoutUpdateDefaultParcelTemplate(this, objectId, options));
    }
    ...
    async deleteDefaultParcelTemplate(options?: RequestOptions): Promise<void> {
        return unwrapAsync(ratesAtCheckoutDeleteDefaultParcelTemplate(this, options));
    }
}
