...
export class Webhooks extends ClientSDK {
    ...
    async listWebhooks(options?: RequestOptions): Promise<components.WebhookPaginatedList> {
        return unwrapAsync(webhooksListWebhooks(this, options));
    }
    ...
    async getWebhook(webhookId: string, options?: RequestOptions): Promise<components.Webhook> {
        return unwrapAsync(webhooksGetWebhook(this, webhookId, options));
    }
    ...
    async updateWebhook(
        ...
        return unwrapAsync(webhooksUpdateWebhook(this, webhookId, webhookUpdateRequest, options));
    }
