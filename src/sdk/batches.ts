...
export class Batches extends ClientSDK {
    ...
    async create(
        ...
        return unwrapAsync(batchesCreate(this, request, options));
    }
    ...
    async get(batchId: string, options?: RequestOptions): Promise<components.Batch> {
        return unwrapAsync(batchesGet(this, batchId, options));
    }
    ...
    async addShipments(
        ...
        return unwrapAsync(batchesAddShipments(this, batchId, requestBody, options));
    }
    ...
    async purchase(batchId: string, options?: RequestOptions): Promise<components.Batch> {
        return unwrapAsync(batchesPurchase(this, batchId, options));
    }
    ...
    async removeShipments(
        ...
        return unwrapAsync(batchesRemoveShipments(this, batchId, requestBody, options));
    }
}
