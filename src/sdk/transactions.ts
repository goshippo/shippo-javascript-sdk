...
export class Transactions extends ClientSDK {
    ...
    async list(
        ...
        return unwrapAsync(transactionsList(this, request, options));
    }
    ...
    async create(
        ...
        return unwrapAsync(transactionsCreate(this, request, options));
    }
    ...
    async get(transactionId: string, options?: RequestOptions): Promise<components.Transaction> {
        return unwrapAsync(transactionsGet(this, transactionId, options));
    }
}
