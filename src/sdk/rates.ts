...
export class Rates extends ClientSDK {
    ...
    async get(rateId: string, options?: RequestOptions): Promise<components.Rate> {
        return unwrapAsync(ratesGet(this, rateId, options));
    }
    ...
    async listShipmentRates(
        ...
        return unwrapAsync(ratesListShipmentRates(this, shipmentId, page, results, options));
    }
    ...
    async listShipmentRatesByCurrencyCode(
        ...
        return unwrapAsync(ratesListShipmentRatesByCurrencyCode(this, request, options));
    }
}
