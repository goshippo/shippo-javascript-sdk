...
| `serviceLevelToken`                                                                                                                     | *string*                                                                                                                                | :heavy_minus_sign:                                                                                                                      | Service level token, e.g. `usps_priority` or `fedex_ground`.<br><br/>See <a href="/shippoapi/public-api/service-levels">Service Levels</a>. | ups_next_day_air_saver                                                                                                                  |