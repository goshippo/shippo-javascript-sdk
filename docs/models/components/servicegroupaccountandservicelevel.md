...
| `serviceLevelToken`                                                                                                      | *string*                                                                                                                 | :heavy_minus_sign:                                                                                                       | Service level token, e.g. `usps_priority` or `fedex_ground`.<br/>See [Service Levels](/shippoapi/public-api/service-levels). | ups_next_day_air_saver                                                                                                   |