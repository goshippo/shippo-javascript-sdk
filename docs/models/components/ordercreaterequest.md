...
| `lineItems`                                                                                                                                                                    | [components.LineItemBase](../../models/components/lineitembase.md)[]                                                                                                           | :heavy_minus_sign:                                                                                                                                                             | Array of [line item](/shippoapi/public-api/orders/lineitem) objects representing the items in this order. <br/>All objects will be returned expanded by default.               |                                                                                                                                                                                |