...
| `servicelevelToken`                                                                                                                                                                                                                                           | *string*                                                                                                                                                                                                                                                      | :heavy_minus_sign:                                                                                                                                                                                                                                            | A token that sets the shipping method for the batch, overriding the batch default. <br/>Servicelevel tokens can be found [in this list](/shippoapi/public-api/service-levels) <br/>or [at this endpoint](/shippoapi/public-api/carrier-accounts/listcarrieraccounts). | fedex_ground                                                                                                                                                                                                                                                  |
