...
const value: components.WebhookPayloadTrack = {
  data: {
    ...
    trackingHistory: [
      {
        ...
        objectCreated: new Date("2022-01-23T15:12:14.003Z"),
        objectId: "<id>",
        objectUpdated: new Date("2024-04-11T04:23:31.598Z"),
        status: "DELIVERED",
        substatus: {
    ...
    trackingStatus: {
      ...
      objectCreated: new Date("2022-12-17T17:43:52.087Z"),
      objectId: "<id>",
      objectUpdated: new Date("2023-02-25T06:38:03.380Z"),
      status: "DELIVERED",
      substatus: {
        code: "information_received",
        text: "Information about the package received.",
