...
| ------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------- |
| `code`                                                                                      | *string*                                                                                    | :heavy_minus_sign:                                                                          | See <a href="/shippoapi/public-api/address-validation-codes">Address Validation Codes</a>   | Unknown Street                                                                              |
| `source`                                                                                    | *string*                                                                                    | :heavy_minus_sign:                                                                          | See <a href="/shippoapi/public-api/address-validation-source">Address Validation Source</a> | Shippo Address Validator                                                                    |
