...
let value: Track = {
  ...
  trackingHistory: [
    {
      ...
      objectCreated: new Date("2023-12-09T21:35:55.501Z"),
      objectId: "<id>",
      objectUpdated: new Date("2023-04-25T14:17:38.418Z"),
      status: "DELIVERED",
      substatus: {
  ...
  trackingStatus: {
    ...
    objectCreated: new Date("2024-09-04T09:11:49.246Z"),
    objectId: "<id>",
    objectUpdated: new Date("2024-11-22T04:11:06.908Z"),
    status: "DELIVERED",
    substatus: {
      code: "information_received",
      text: "Information about the package received.",
