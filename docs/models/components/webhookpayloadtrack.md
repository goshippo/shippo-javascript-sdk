...
let value: WebhookPayloadTrack = {
  data: {
    ...
    trackingHistory: [
      {
        ...
        objectCreated: new Date("2024-02-23T20:20:27.935Z"),
        objectId: "<id>",
        objectUpdated: new Date("2023-10-23T15:05:16.239Z"),
        status: "DELIVERED",
        substatus: {
    ...
    trackingStatus: {
      ...
      objectCreated: new Date("2023-08-21T04:36:26.084Z"),
      objectId: "<id>",
      objectUpdated: new Date("2023-04-10T07:48:57.030Z"),
      status: "DELIVERED",
      substatus: {
        code: "information_received",
        text: "Information about the package received.",
