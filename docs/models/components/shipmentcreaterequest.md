...
| `carrierAccounts`                                                                                                                                                                                                                                                     | *string*[]                                                                                                                                                                                                                                                            | :heavy_minus_sign:                                                                                                                                                                                                                                                    | List of [Carrier Accounts](/shippoapi/public-api/carrier-accounts) `object_id`s used to filter <br/>the returned rates.  If set, only rates from these carriers will be returned.                                                                                     | [<br/>"065a4a8c10d24a34ab932163a1b87f52",<br/>"73f706f4bdb94b54a337563840ce52b0"<br/>]                                                                                                                                                                                |
