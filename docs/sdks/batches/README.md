...
import { LabelFileType, PaymentMethod } from "shippo/models/components";
...
async function run() {
  ...
  const result = await sdk.batches.create(shippoApiVersion, batchCreateRequest);
...
async function run() {
  ...
  const result = await sdk.batches.get(batchId, shippoApiVersion);
...
async function run() {
  ...
  const result = await sdk.batches.addShipments(batchId, shippoApiVersion, requestBody);
...
async function run() {
  ...
  const result = await sdk.batches.purchase(batchId, shippoApiVersion);
...
async function run() {
  ...
  const result = await sdk.batches.removeShipments(batchId, shippoApiVersion, requestBody);
